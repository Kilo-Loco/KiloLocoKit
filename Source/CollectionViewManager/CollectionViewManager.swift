...
@available(iOS 13.0, *)
open class CollectionViewManager<Section: Hashable, Item: Hashable>: NSObject, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
...
@available(iOS 13.0, *)
public extension CollectionViewManager where Section == SingleSection {
